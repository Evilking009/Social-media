...
// Close Modal upon Click outside i.e div
// e.target - means clicking on specific item on click. not on whole.
...
fontSizes.forEach((size) => {
  size.addEventListener("click", function () {
    ...
    // Change the font size of Central HTML Element
